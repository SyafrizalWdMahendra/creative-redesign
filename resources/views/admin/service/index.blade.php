            ...
            <div class="card-body">
              <form action="">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="name" placeholder="Masukkan Nama Layanan" required>
                </div>
                <div class="mb-3">
                  <label for="title" class="form-label">Judul Layanan</label>
                  <input type="text" class="form-control" id="title" placeholder="Masukkan Judul Layanan" required>
                </div>
                <div class="mb-3">
                  <label for="quote" class="form-label">Kutipan</label>
                  <input type="text" class="form-control" id="quote" placeholder="Masukkan Kutipan" required>
                </div>
                <div class="mb-3">
