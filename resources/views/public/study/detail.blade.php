      ...
      <div class="container position-relative">
        ...
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current">Study Details</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              <h3>{{ $findStudy->name }}</h3>
              <ul>
                <li>
                  <h5>{{ $findStudy->title }}</h5>
                </li>
                <img src="{{ asset('storage/' . $findStudy->image) }}" style="height: 400px; width: 100%;"
                  class="img-fluid">
                <li>{!! $findStudy->content !!}</li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200">
              <form action="{{ route('search.studies') }}" method="GET">
                @csrf
                <div class="input-group mb-3">
                  <input type="search" name="query" class="form-control rounded" placeholder="Search studies..."
