        ...
        <main class="main">
            ...
            >
                <div class="container position-relative">
                    <h1>Karya Siswa</h1>
                    <p>
                        Beberapa hasil karya dari siswa kami yang telah dibuat pada tiap kelasnya.
                    </p>
                    <nav class="breadcrumbs">
                        <ol>
                            <li><a href="{{ route('index') }}">Beranda</a></li>
                            <li class="current">Karya Siswa</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <section id="services" class="services section">
                ...
                <h2>Karya Siswa</h2>
                <p>Semua Karya Siswa<br></p>
                </div><!-- End Section Title -->

                <div class="container" data-aos="fade-up" data-aos-delay="100">
                    <div class="row gy-5">
                        @forelse ($studentWorks as $student)
                            <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                                <div class="services-item">
                                    <div class="img">
                                        <img src="{{ asset('storage/' . $student->image) }}" style="height: 300px; width: 100%;" class="img-fluid">
                                    </div>
                        ...
                        @empty
                            <div class="col-12">
                                <p>Student Works not available</p>
                            </div>
                        @endforelse
                    </div>
                </div>
