        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
              <form action="{{ route('search.teams') }}" method="GET" class="col-lg-4" id="searchForm">
                @csrf
          ...
          <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form id="editForm" action="{{ route('team_admin.update', ':id') }}" method="POST"
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="3"
                      placeholder="Masukkan Profil Singkat" required>{{ $team->description }}</textarea>
                  </div>
                  <div class="mb-3">
                    <label for="image" class="form-label">Foto Profil</label>
                    <img id="preview-image" src="{{ asset('storage/' . $team->image) }}" alt="Artikel Image"
