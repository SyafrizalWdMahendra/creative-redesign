        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
              <form action="{{ route('search.study_works') }}" method="GET" class="col-lg-4" id="searchForm">
                @csrf
          ...
          <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form id="editForm" action="{{ route('student_work_admin.update', ':id') }}" method="POST"
                  ...
                  <div class="mb-3">
                    ...
                    <img id="preview-image" src="{{ asset('storage/' . $student->image) }}" alt="Artikel Image"
                  ...
                  <div class="mb-3">
                    ...
                    <textarea id="description" name="description" class="form-control"
                      placeholder="Masukkan Deskripsi Karya" required>{{ $student->description }}</textarea>
                  </div>
