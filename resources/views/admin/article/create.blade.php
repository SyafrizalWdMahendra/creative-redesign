            ...
            <div class="card-body">
              <form action="{{ route('article_admin.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="title" class="form-control" id="name" placeholder="Masukkan Judul Artikel"
                    value={{ old('title') }}>
                  @error('title')
                ...
                <div class="mb-3">
                  <label for="date" class="form-label">Tanggal Posting <span class="text-danger">*</span></label>
                  <input type="date" name="date" class="form-control" id="date" placeholder="Masukkan Tanggal Posting"
                    value={{ old('date') }}>
                    @error('date')
                      <div class="text-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                  <label for="description" class="form-label">Deskripsi Konten <span class="text-danger">*</span></label>
