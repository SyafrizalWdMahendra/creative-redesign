        ...
        <main class="main">
            ...
            >
                <div class="container position-relative">
                    <h1>Bidang Studi</h1>
                    <p>
                        15 bidang studi unggulan dari kami yang bisa Anda ikuti.
                    </p>
                    <nav class="breadcrumbs">
                        <ol>
                            <li><a href="{{ route('index') }}">Beranda</a></li>
                            <li class="current">Bidang Studi</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        @forelse ($studies as $study)
                            <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                                <div class="studies-item">
                                    <div class="img">
                                        <img src="{{ asset('storage/' . $study->image) }}" style="height: 300px; width: 100%;" class="img-fluid">
                                    </div>
